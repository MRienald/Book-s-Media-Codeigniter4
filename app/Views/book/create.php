...
<main>
    <div class="container-fluid px-4">
        ...
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item active">Create Data Book</li>
        </ol>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <!-- Form Data -->
                <form action="<?= route_to('save-buku')?>" method="post" enctype="multipart/form-data">
                    <?= csrf_field() ?>
                    <div class="mb-3 row">
                        <label for="title" class="col-sm-2 col-form-label">Title</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control <?= 
                            $validation->hasError('title') ? 'is-invalid' : ''?>" name="title" value="<?= old('title')?>">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control <?= 
                            $validation->hasError('author') ? 'is-invalid' : ''?>" name="author" value="<?= old('author')?>">
                            <div id="validationServer03Feedback" class="invalid-feedback">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control <?= 
                            $validation->hasError('publisher') ? 'is-invalid' : ''?>" name="publisher" value="<?= old('publisher')?>">
                            <div id="validationServer03Feedback" class="invalid-feedback">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-4">
                        <input type="text" class="form-control <?= 
                            $validation->hasError('release_year') ? 'is-invalid' : ''?>" name="release_year" value="<?= old('release_year')?>">
                            <div id="validationServer03Feedback" class="invalid-feedback">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control <?= 
                            $validation->hasError('price') ? 'is-invalid' : ''?>" name="price" value="<?= old('price')?>">
                            <div id="validationServer03Feedback" class="invalid-feedback">
                        ...
                        <div class="col-sm-4">
                        <input type="text" class="form-control <?= 
                            $validation->hasError('discount') ? 'is-invalid' : ''?>" name="discount" value="<?= old('discount')?>">
                            <div id="validationServer03Feedback" class="invalid-feedback">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-4">
                        <input type="text" class="form-control <?= 
                            $validation->hasError('stock') ? 'is-invalid' : ''?>" name="stock" value="<?= old('stock')?>">
                            <div id="validationServer03Feedback" class="invalid-feedback">
                    ...
                    <div class="mt-3 row">
                        ...
                        <div class="col-md-6">
                            <img src="/img/tumbnail.png" alt="" class="img-preview img-thumbnail">
                        </div>
                        </div>
                    </div>
